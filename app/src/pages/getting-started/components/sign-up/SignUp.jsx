  ...
  return (
    <form className="w-full flex flex-col space-y-2">
      ...
      <div className="flex items-center space-x-2 border-2 border-gray-500 rounded-md w-full p-2">
        ...
        <input type={passwordType} className=" w-full outline-none rounded-md placeholder-gray-500" placeholder="Enter password"></input>

        <button type="button" className="passwordBtn" onClick={handlePasswordType}>
          {passwordType == "text" ? (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      ...
      <div className="flex items-center space-x-2 border-2 border-gray-500 rounded-md w-full p-2">
        ...
        <input type={passwordType} className=" w-full outline-none rounded-md placeholder-gray-500" placeholder="Enter confirm password"></input>
